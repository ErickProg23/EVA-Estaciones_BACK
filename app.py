...
app.register_blueprint(estacion_bp, url_prefix='/api')
app.register_blueprint(rol_bp, url_prefix='/api')
app.register_blueprint(puestos_bp, url_prefix='/api')
app.register_blueprint(personal_bp, url_prefix='/api')
app.register_blueprint(aspecto_bp, url_prefix='/api')
app.register_blueprint(evaluacion_bp, url_prefix='/api')
app.register_blueprint(tickets_bp, url_prefix='/api')
app.register_blueprint(reportes_bp, url_prefix='/api')
app.register_blueprint(dashboard_bp, url_prefix='/api')
app.register_blueprint(productos_bp, url_prefix='/api')
app.register_blueprint(bombas_bp, url_prefix='/api')
app.register_blueprint(lecturas_manuales, url_prefix='/api')
app.register_blueprint(materiales_bp, url_prefix='/api')
app.register_blueprint(solicitudes_bp, url_prefix='/api')
app.register_blueprint(configuraciones_litros_bp, url_prefix='/api')
